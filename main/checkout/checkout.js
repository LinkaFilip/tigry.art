...
packetaButton.addEventListener("click", (e) => {
  ...
  Packeta.Widget.pick({ apiKey: "45e618492867392e" }, (point) => {
    ...
    if (countryCode === "cz") {
      ...
      if (shippingMethod === "zbox") shippingFee = 350;
      else shippingFee = 350;
    } else if (countryCode === "ro") {
      if (shippingMethod === "zbox") shippingFee = 400;
  ...
  const style = {
    ...
    invalid: {
      ...
      borderColor: "var(--x-default-color-accent)",
      boxShadow: "0 0 0 1px var(--x-default-color-accent)"
    }
  };
