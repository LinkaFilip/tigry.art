export default async (request, context) => {
  ...
  response.headers.set(
    ...
    `script-src 'self' 'nonce-${nonce}' https://js.stripe.com https://widget.packeta.com; style-src 'self' 'nonce-${nonce}' 'unsafe-hashes' 'sha256-T6AAKdWxO6p6GZVyzGAJDSLhOoPuuoZ6LlqMX153CvM=' 'sha256-fg7eWI6NKGc7F4Z8BQ12kLu3YHpTZgRat9GYbZDyvPM=' 'sha256-qnVkQSG7pWu17hBhIw0kCpfEB3XGvt0mNRa6+uM6OUU=' 'sha256-4b6rNDboSsZEaqN6Og63Hi0eYh3uYPNUHR1oQ8LMKoY=' 'sha256-rmNO4l4SSxtfucFsayNzWLfapzbl/2uXkL4mbZqAkiY=' 'sha256-yyKvG+1MOCo5oWMut5dCaFDe6JXHSC/pOxSjwbFSGQU=' https://js.stripe.com https://widget.packeta.com; object-src 'none'; base-uri 'self';`
  );
